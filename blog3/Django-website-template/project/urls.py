...
from .views import (rate_limiter_view, view_404,
                    handler_403, home_view, packing_list_view)  # subscribe_view
from . import views
...
urlpatterns = [
    ...
    #path('packing/', packing_generator, name="packing"),
    path('packing', packing_list_view, name="packing"),

    #path("packing-list/", views.packing_list_view, name="packing-list"),
